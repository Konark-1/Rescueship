/**
 * ScrollStory Engine — sticky scroll chapters with progress tracking.
 */
...
/* Chapter number indicator (right side) */
...
/* Map progress to a sub-phase (0→1 within a range) */
